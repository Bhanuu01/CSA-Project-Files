...
class SignalBundle:
    """Static control signal bundle derived from an instruction category."""
...
INSTR_CONTROL_MAP = {
    ...
    INSTR_TYPES.LOAD_I: SignalBundle(
        AluSrc=1,
        MemtoReg=1,
        RegWrite=1,
        MemRead=1,
...
INSTR_TYPE_TO_CONTROL = INSTR_CONTROL_MAP